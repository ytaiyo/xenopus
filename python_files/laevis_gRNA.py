...
# Open the L sgRNA list, downloaded from CRISPRscan as a .TSV file (needs to be in the same folder as this file and be named L.tsv)
with open('L.tsv', 'r') as file1:
    reader1 = csv.DictReader(file1, delimiter='\t')
    data1 = list(reader1)

# Open the S sgRNA list, downloaded from CRISPRscan as a .TSV file (needs to be in the same folder as this file and be named S.tsv)
